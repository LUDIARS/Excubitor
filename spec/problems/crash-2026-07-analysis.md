...
- [WP1: supervisor / fatal-handler / docker timeout](crash-fix-wp1-supervisor.md) — 最優先・小規模
- [WP2: 子プロセス管理の共通化](crash-fix-wp2-child-process.md)
- [WP3: ログ系バッファ上限](crash-fix-wp3-log-buffers.md)
- [WP4: DB 衛生](crash-fix-wp4-db-hygiene.md)
