// /api/v1/reviews/* 窶・LUDIARS 蜈ｨ繝ｪ繝昴・ review/ 繝輔か繝ｫ繝繧・Excubitor 縺九ｉ讓ｪ譁ｭ髢ｲ隕ｧ縺吶ｋ縲・
//
// Skill `ludiars-review` 縺悟推繝ｪ繝昴・ review/<YYYY-MM-DD>/REVIEW_*.md 縺ｨ
// review/latest.json 繧呈嶌縺榊・縺吶・縺薙％縺ｧ縺ｯ繝輔ぃ繧､繝ｫ繧ｷ繧ｹ繝・Β邨檎罰縺ｧ縺昴・縺ｾ縺ｾ霑斐☆縲・
