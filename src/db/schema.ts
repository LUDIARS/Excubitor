...
const MIGRATIONS: string[] = [
  ...
  `CREATE INDEX IF NOT EXISTS idx_service_instance_logs_instance_ts ON service_instance_logs (service_instance_id, ts DESC, id DESC)`,
  `CREATE INDEX IF NOT EXISTS idx_liveness_history_instance_latest ON liveness_history (service_instance_id, probed_at DESC, id DESC)`,
  `CREATE INDEX IF NOT EXISTS idx_liveness_history_instance_time ON liveness_history (service_instance_id, probed_at)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_error_tasks_state_seen ON error_tasks (state, last_seen_at DESC)`,
  `CREATE INDEX IF NOT EXISTS idx_error_tasks_seen ON error_tasks (last_seen_at DESC)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_auto_fix_runs_task_created ON auto_fix_runs (error_task_id, created_at DESC)`,
  `CREATE INDEX IF NOT EXISTS idx_auto_fix_runs_created ON auto_fix_runs (created_at DESC)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_memory_samples_target_source_latest ON memory_samples (target_kind, target_key, source, sampled_at DESC)`,
